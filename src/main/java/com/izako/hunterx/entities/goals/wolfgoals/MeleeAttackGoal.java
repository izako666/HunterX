...
public class MeleeAttackGoal extends Goal {
	   ...
	   public MeleeAttackGoal(CreatureEntity creature, double speedIn, boolean useLongMemory, LivingEntity owner) {
	   ...
	   protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
	      ...
	      if (distToEnemySqr <= d0 && this.attackTick <= 0) {
	         ...
	         if(this.owner != null) {
	        	...
	        	damage = (float) Helper.fromRangeToRange(100, 200, 5, 10, data.getNenCapacity());
	         }
