...
public class KirikoModel<T extends Entity> extends EntityModel<T> {

	private final RendererModel Rleg;
	private final RendererModel Rleg2;
	private final RendererModel Lleg;
	private final RendererModel lleg2;
