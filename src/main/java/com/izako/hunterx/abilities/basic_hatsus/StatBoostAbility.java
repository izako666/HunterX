...
public class StatBoostAbility extends PassiveAbility implements ITrainable, IBlacklistPassive {
	...
	public void onStartPassive(LivingEntity p) {
		...
		AttributeModifier aMod = new AttributeModifier(ATTACK, "statboost_attack", Helper.getTrueValue(10, this, p),
				Operation.ADDITION);
		AttributeModifier dMod = new AttributeModifier(DEFENSE, "statboost_defense", Helper.getTrueValue(15, this, p),
				Operation.ADDITION);
		try {
