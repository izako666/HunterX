...
public class CharacterCreatorScreen extends Screen {
	...
	public void init(Minecraft mc, int mouseX, int mouseY) {
		...
		baseX = mc.getMainWindow().getScaledWidth() / 2 - 128;
		baseY = mc.getMainWindow().getScaledHeight() / 2 - 128;
	...
	private void reInit() {
		...
		case 0:
           ...
           break;
		case 1:
			Slider redSlider = new Slider(baseX + 20, baseY + 140, 128, 20, "red", "slider", 1, 255, 1, false, false, b -> {}, s -> this.changeColor(s, "red"));
			Slider greenSlider = new Slider(baseX + 20, baseY + 170, 128, 20, "green", "slider", 1, 255, 1, false, false, b -> {}, s -> this.changeColor(s, "green"));
			Slider blueSlider = new Slider(baseX + 20, baseY + 200, 128, 20, "blue", "slider", 1, 255, 1, false, false, b -> {}, s -> this.changeColor(s, "blue"));
	...
	private void changeColor(Slider slider, String type) {				
